      ...
      return (
            <div className='app-container'>
                <header className='app-header'>
                    <div className='marvel-brand'>
                        <div className='marvel-svg-box'>
                            <svg 
                                ...
                                <g>
                                    <rect 
                                        x="-215.19" y="-86.608" fill="#ED1D24" 
                                        width="100%" height="100%"
                                    />
                                    <g>
                                        <path style={{fill:"#FFFFFF"}} d="M631.063,7.184v-61.603H459.644l-28.191,205.803L403.557-54.418H341.74l6.925,54.915
